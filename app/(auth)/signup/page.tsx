            ...
            <div className="w-full max-w-md px-6 h-screen flex flex-col justify-between py-12 md:py-0">
                ...
                <form onSubmit={onSubmit} className='h-full w-full flex flex-col justify-center gap-4 items-center'>
                    ...
                    <div className="w-full space-y-3">
                        <button className="w-full gap-2 flex justify-center items-center text-sm font-normal text-zinc-700 h-9 cursor-pointer rounded-sm border-zinc-200 border-2 hover:bg-zinc-50 transition-colors">
                    ...
                    <div className="flex flex-col w-full gap-1">
                        ...
                        <input value={email} onChange={(e) => setEmail(e.target.value)} placeholder='Enter your email' autoComplete='off' id='Email' type="email" className='rounded-sm px-2 text-sm font-normal text-zinc-700 border-zinc-200 border-2 h-9 placeholder:text-sm placeholder:text-zinc-200 placeholder:font-normal focus:outline-zinc-500' />
                    </div>
